...
<div style="display: flex; flex-wrap: wrap; gap: 10px; font-size: 20px; line-height: 36px;">

  <span style="display: inline-flex; align-items: center; padding: 6px 10px; border: 1px solid #ddd; border-radius: 20px;">
